...
export default function OptimisticLike({ subscribeData }: OptimisticSubscribeProps) {
  const defaultSubscribeState = {
    subscribers: subscribeData?.subscribers,
    subscribed: subscribeData?.subscribed,
  };
  ...
  const newSubscribeStatus = {
    ...
    subscribers: subscribeState.subscribed
      ? subscribeState.subscribers - 1
      : subscribeState.subscribers + 1,
  };
